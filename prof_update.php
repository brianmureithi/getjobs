						  ...
						  <fieldset>
							<div class="container-fluid">
							  ...
							  <div class="col-md-6 col-xs-12">
								...
								<div class="picture" >
								<img src="'.$row['prof_pic'].'" height="300" width="250px" style="padding:10px; object-fit: cover; height:300px; width:300px;" id="profileDisplay">
								</div>
								...
								<input type="file" name="profile" class="form-control" id="profileSelect" style="display: none;" />
