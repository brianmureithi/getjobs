...
<html>
  ...
  <body>
    ...
    <div class="container">
      <form action="sendwork_exec.php?workid=<?php echo $_GET['workid'];?>" method="post" id="fileform" role="form" enctype="multipart/form-data">
        <fieldset>
        <div class="container-fluid">
      <div class="row"> 
        <div class="col-md-6 col-xs-12">
          <legend class="text-center"><h4>SUBMIT WORK TO
            <?php
            $workid=$_GET['workid'];
            global $dbhandle;
