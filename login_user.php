...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" style="background-color:#B22222 !important">
	...
	<div class="row vertical-offset-100">
			...
			<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-default">
			<h4><b style="font-family:calgiari">If you are an expert ,then you should not be here, kidly signup and login here</b></h5>
			<a href="signup.php"><button type="button" class="btn btn-lg btn-primary btn-block"> Expert Sign up </button></a>
			</div>
			</div>
